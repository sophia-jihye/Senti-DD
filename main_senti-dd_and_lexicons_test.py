...
report_filepath =os.path.join(target_result_dir, 'classification_report_{}.csv')
conf_filepath =os.path.join(target_result_dir, 'confusion_matrix_{}.csv')
df_filepath =os.path.join(target_result_dir, 'predictions_{}.csv')
...
if __name__ == '__main__':
    ...
    # Predict polarity based on lexicon_list
